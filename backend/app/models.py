...
class LootCredential(Base):
    __tablename__ = "loot_credentials"
...
class DomainFinding(Base):
    __tablename__ = "domain_findings"
...
class DomainUserList(Base):
    __tablename__ = "domain_user_lists"
